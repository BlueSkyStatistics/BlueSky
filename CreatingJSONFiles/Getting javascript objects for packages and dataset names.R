...
#The code below does not allow me to create a BlueSky Package, however this code works in the R editor
...
AllPackages <- c("All_Installed_Packages", AllPackages)
...
writeLines(packages_and_datasets_json,
