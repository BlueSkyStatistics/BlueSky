...
BSkyMultipleEditDataGrid <-function(startRow =2, startCol =1, noOfRows =4, 
                          noOfCols=3,
                          data = c( "1","2","3","uu","abc","6","7","","xty","10","11","12" ),
                          dataSetNameOrIndex ="mtcars")
{
...
#print(every_column)
    ...
    if ("numeric" %in% classOfVariable ||"integer" %in% classOfVariable )
    {
     ...
     #})
      ...
      empty_numeric_count <-sum(is.na(every_column) == TRUE)
